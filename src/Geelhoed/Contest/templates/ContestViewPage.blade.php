            ...
            <tr>
                ...
                <td>
                    @foreach ($contest->getContestMembers() as $contestMember)
                        ...
                        {{ $member->getProfile()->getFullName() }}@if (!$loop->last)
                            ,
                        @endif
                    @endforeach
                </td>
                    ...
                    @component('View/Widget/Form/FormWrapper', ['id' => 'gcv-edit-date', 'label' => 'Datum, starttijd, endtijd'])
                        @slot('right')
                            <input id="gcv-edit-date" name="date" type="date" class="form-control form-control-inline"
                                   required>
                            <input id="gcv-edit-startTime" name="startTime" type="time" class="form-control form-control-inline"
                                   required>
                            <input id="gcv-edit-endTime" name="endTime" type="time" class="form-control form-control-inline"
                                   required>
                        @endslot
                    @endcomponent
