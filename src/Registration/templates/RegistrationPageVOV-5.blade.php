...
@section ('contents')
    ...
    @else
        ...
        <form method="post" action="/event-registration/add" class="form-horizontal" id="kaartenbestellen">
            <input type="hidden" name="csrfToken" value="{{ \Cyndaron\User\UserSession::getCSRFToken('event-registration', 'add') }}"/>
            ...
            @include('View/Widget/Form/Number', ['id' => 'participatedBefore', 'label' => 'Hoeveel keren heeft u de Matthaüs-Passion al gezongen?', 'value' => 0, 'min' => 0, 'max'=> 50, 'step' => 1])


{{--            <div class="form-group row">--}}
{{--                <label class="col-sm-3 col-form-label">Eerder meegedaan?</label>--}}
{{--                <div class="col-sm-5">--}}
{{--                    <input id="participatedBefore1" name="participatedBefore" type="radio" value="1"/> <label for="participatedBefore1">Ik heb 1 keer eerder meegedaan</label><br>--}}
{{--                    <input id="participatedBefore1" name="participatedBefore" type="radio" value="2"/> <label for="participatedBefore1">Ik heb 2 tot 4 keer eerder meegedaan</label><br>--}}
{{--                    <input id="participatedBefore1" name="participatedBefore" type="radio" value="5"/> <label for="participatedBefore1">Ik heb 5 keer of mee eerder meegedaan</label><br>--}}
